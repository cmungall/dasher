...
class KnowledgeSource(YAMLRoot):
    ...
    url: Optional[Union[str, UrlType]] = None
    ...
    def __post_init__(self, **kwargs: Dict[str, Any]):
        ...
        if self.url is not None and not isinstance(self.url, UrlType):
            self.url = UrlType(self.url)
        super().__post_init__(**kwargs)
...
class Registry(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SEMQC.Registry
    class_class_curie: ClassVar[str] = "semqc:Registry"
    class_name: ClassVar[str] = "registry"
    class_model_uri: ClassVar[URIRef] = SEMQC.Registry

    id: Union[str, RegistryId]
    has_knowledge_sources: List[Union[str, KnowledgeSourceId]] = empty_list()
...
class Problem(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SEMQC.Problem
    class_class_curie: ClassVar[str] = "semqc:Problem"
    class_name: ClassVar[str] = "problem"
    class_model_uri: ClassVar[URIRef] = SEMQC.Problem

    description: Optional[str] = None

@dataclass
class DownloadProblem(Problem):
    """
    A problem in downloading a knowledge source
    """
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = SEMQC.DownloadProblem
    class_class_curie: ClassVar[str] = "semqc:DownloadProblem"
    class_name: ClassVar[str] = "download problem"
    class_model_uri: ClassVar[URIRef] = SEMQC.DownloadProblem
...
slots.description = Slot(uri=SEMQC.description, name="description", curie=SEMQC.curie('description'),
                      model_uri=SEMQC.description, domain=None, range=Optional[str], mappings = [DCTERMS.description])
...
slots.has_knowledge_sources = Slot(uri=SEMQC.has_knowledge_sources, name="has knowledge sources", curie=SEMQC.curie('has_knowledge_sources'),
                      model_uri=SEMQC.has_knowledge_sources, domain=None, range=List[Union[str, KnowledgeSourceId]])
...
slots.title = Slot(uri=SEMQC.title, name="title", curie=SEMQC.curie('title'),
                      model_uri=SEMQC.title, domain=None, range=Optional[str], mappings = [DCTERMS.title])

slots.url = Slot(uri=SEMQC.url, name="url", curie=SEMQC.curie('url'),
                      model_uri=SEMQC.url, domain=None, range=Optional[Union[str, UrlType]])
